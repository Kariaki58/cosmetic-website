...
import Categories from "../home/category-best-seller";
        ...
        <div className="relative rounded-lg overflow-hidden w-[280px] flex-shrink-0 mx-2">
            ...
            <div className="mt-4">
                ...
                <Link 
                    ...
                    className="text-lg  font-semibold text-gray-800 hover:underline line-clamp-2 truncate"
                >
                    {product.name}
                </Link>
        ...
        <section className="py-16">
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <Link href="/products" className="text-sm text-pink-500 hover:underline">
                        View All
                    </Link>
                </div>
